...
- **Creaci�n de Proyecto Django**: Se inicializ� un proyecto Django en la carpeta rontend/ y la aplicaci�n pp_frontend.
- **Vistas (MVT)**: Se crearon vistas que utilizan la librer�a equests para consumir la API FastAPI internamente.
- **Plantillas HTML**: Se dise�aron plantillas con Bootstrap 5 para el CRUD de productos y la creaci�n/listado de pedidos.
